...
VALUES
    ...
    ('M', 1, 'Salas', 'Wynter', 'salas-wynter1587@outlook.fr', '1971-01-04', '$2y$12$a.uNrpwK08AM4GAKfsr9hO9XAg2na7Z81B40yOyu7D/ofk1qkJTly', 'True','2022-02-18','0757626251'),
    ...
    ('Mlle', 1, 'Hensley', 'Kennedy', 'kennedy_hensley1420@hotmail.fr', '1964-11-08', '$2y$12$Cz8OTQ7H2y/oiyj6zRNQpOUy6A9A5hcbnfo9wvJ5riR2i9MFeJ/v2', 'False','2022-02-08','0708837451'),
    ...
    ('M', 1, 'Gibson', 'Evangeline', 'gibson-evangeline@yahoo.fr', '1986-11-03', '$2y$12$fKGg5gWf7ceh1pAIGfm4VePtsqX1v8nBt91eNTeIqceUKvvpp3IJK', 'False','2022-02-17','0728168777'),
    ...
    ('M', 2, 'Carpentier', 'Aina', 'aina.carpentier@vinotrip.fr', '1900-09-13', '$2y$12$m1t1E3Ce1FakJ.28vX3jreyQqBHPMHde5zvkkePfzKkh17o/qAHN.', 'False','2022-09-11','0788524453'),
...
------------------------------------------------- SEJOUR
INSERT INTO
    sejour (idCategorieSejour, idTheme, idCategorieVignoble, idCategorieParticipant, idDuree, titreSejour, photoSejour, descriptionSejour, prixSejour, idLocalite)
VALUES
    (2, 5, 4, 3, 2, 'Dégustation de vins réputés en Bourgogne', 'sejour1.jpg', 'Un séjour immersif au coeur d''un domaine viticole, avec des visites guidees des vignes et des degustations de vins uniques.', 727.00, 6),
    (4, 4, 1, 3, 3, 'Escapade gourmande', 'sejour2.jpg', 'Decouvrez les plaisirs de la gastronomie locale en associant mets raffines et vins d''exception dans un cadre pittoresque.', 673.00, null),
    (4, 1, 14, 3, 1, 'Week-end detente et vin', 'sejour3.jpg', 'Un week-end de detente dans un cadre tranquille, avec des visites de vignobles et des moments de relaxation en plein air.', 328.50, 30),
    (1, 1, 10, 1, 4, 'Séjour decouverte en Provence', 'sejour4.jpg', 'Plongez dans l''art de la viticulture provençale, visitez des domaines viticoles et profitez de la beaute des paysages.', 106.00, 24),
    (4, 6, 4, 2, 2, 'Escapade romantique au domaine', 'sejour5.jpg', 'Un séjour romantique dans un domaine vinicole, avec des activites de degustation et des repas aux chandelles dans les caves.', 645.00, 7),
    (4, 5, 4, 1, 3, 'Séjour tout inclus en Bourgogne', 'sejour6.jpg', 'Séjour tout compris avec transport, hebergement, visites des plus grands domaines viticoles et degustations de crus renommes.', 423.00, 10),
    (1, 4, 3, 3, 1, 'Séjour oenologique a Bordeaux', 'sejour7.jpg', 'Un séjour dedie a l''oenologie dans la region bordelaise, avec des ateliers de degustation et des visites des plus celebres châteaux.', 790.50, 11),
    (1, 4, 6, 1, 4, 'Séjour luxe en Champagne', 'sejour8.jpg', 'Vivez un séjour de luxe dans la region de Champagne, incluant des visites de maisons prestigieuses et des degustations de champagnes rares.', 431.00, null),
    (4, 3, 3, 2, 2, 'Séjour au château', 'sejour9.jpg', 'Sejournez dans un château viticole et profitez de visites privees, de degustations haut de gamme et de moments de relaxation dans un cadre idyllique.', 527.00, 3),
    (2, 3, 2, 1, 3, 'Séjour gastronomique et viticole', 'sejour10.jpg', 'Un séjour axe sur l''association des vins et des mets, avec des repas gastronomiques et des degustations de grands crus.', 126.00, null),
    (3, 1, 13, 2, 4, 'Aventure viticole dans le Val-de-Loire', 'sejour11.jpg', 'Explorez la vallee de la Loire a travers des visites de vignobles locaux, des degustations et des promenades en bateau.', 699.00, null),
    (4, 5, 14, 2, 1, 'Séjour dans les Côtes du Rhône', 'sejour12.jpg', 'Vivez un séjour inoubliable dans les Côtes du Rhône avec des visites de domaines, des degustations privees et des repas typiques de la region.', 680.50, 25),
    (1, 1, 7, 2, 2, 'Séjour decouverte des vins du Jura', 'sejour13.jpg', 'Un séjour unique a la decouverte des vins du Jura, avec des visites de caves, des degustations et des activites locales.', 229.00, 18),
    (4, 1, 1, 1, 3, 'Séjour au domaine en Alsace', 'sejour14.jpg', 'Sejournez dans un domaine viticole alsacien et explorez les traditions viticoles de la region a travers des visites et des degustations.', 514.00, 12),
    (2, 2, 2, 2, 1, 'Week-end vin et nature', 'sejour15.jpg', 'Un week-end en pleine nature, avec des randonnees dans les vignes, des degustations et des repas dans un cadre verdoyant.', 779.00, null),
    (4, 4, 4, 3, 4, 'Séjour decouverte de l''oenologie', 'sejour16.jpg', 'Apprenez les secrets de l''oenologie lors de ce séjour avec des ateliers pratiques et des visites de vignobles.', 288.00, 8),
    (4, 5, 4, 3, 2, 'Séjour spa et vins', 'sejour17.jpg', 'Profitez de l''alliance parfaite entre relaxation et degustation de vins dans un cadre spa luxueux au coeur d''un vignoble.', 601.50, 9),
    (2, 6, 9, 2, 3, 'Séjour de Noël au château', 'sejour18.jpg', 'Venez passer Noël au château, avec un programme de degustation de vins et de repas festifs dans une ambiance magique.', 588.00, null),
    (4, 3, 6, 2, 1, 'Séjour sur les traces du vin', 'sejour19.jpg', 'Un séjour sur mesure pour les passionnes de vin, avec des visites guidees et des decouvertes des meilleurs vignobles.', 757.00, 10),
    (4, 6, 4, 2, 4, 'Séjour au coeur de la Bourgogne', 'sejour20.jpg', 'Immersion totale dans le terroir bourguignon, avec des degustations de vins fins et des repas traditionnels.', 393.00, 6),
    (3, 3, 2, 1, 3, 'Séjour en amoureux dans les vignes', 'sejour21.jpg', 'Un séjour romantique, avec des chambres avec vue sur les vignes, des degustations de vin et des repas aux chandelles.', 474.00, null),
    (4, 5, 3, 3, 2, 'Séjour tout confort a Saint-Emilion', 'sejour22.jpg', 'Séjour tout confort dans la region de Saint-Emilion, avec des visites des plus prestigieux châteaux et degustations privees.', 209.00, 19),
    (3, 5, 1, 3, 4, 'Séjour nature et vin en montagne', 'sejour23.jpg', 'Séjour en montagne avec des randonnees au milieu des vignes et des degustations de vins de montagne dans un cadre exceptionnel.', 236.00, null),
    (2, 2, 7, 3, 1, 'Séjour a la decouverte des vins bio', 'sejour24.jpg', 'Un séjour axe sur la decouverte des vins biologiques, avec des visites de domaines ecoresponsables et des degustations en pleine nature.', 267.00, null),
    (2, 4, 11, 3, 2, 'Séjour decouverte en Savoie', 'sejour25.jpg', 'Venez decouvrir la Savoie sous un autre angle avec des visites de vignobles locaux et des degustations de vins typiques de la region.', 282.50, 7),
    (3, 3, 2, 2, 3, 'Séjour au coeur du Beaujolais', 'sejour26.jpg', 'Decouvrez les crus du Beaujolais avec des visites privees de vignobles et des degustations de vins renommes dans un cadre bucolique.', 635.00, 31),
    (4, 6, 8, 2, 4, 'Séjour oenologique en Languedoc', 'sejour27.jpg', 'Un séjour unique pour explorer les vins du Languedoc, avec des ateliers de degustation et des visites de caves historiques.', 437.00, 8),
    (1, 6, 4, 1, 1, 'Escapade viticole a Chablis', 'sejour28.jpg', 'Venez explorer l''un des plus celebres vignobles de France, avec des degustations de Chablis, et une immersion dans l''histoire viticole de la region.', 163.00, null),
    (2, 5, 14, 3, 3, 'Séjour decouverte des vins de la vallee du Rhône', 'sejour29.jpg', 'Un voyage dans la vallee du Rhône pour decouvrir ses vins iconiques, avec des visites guidees de châteaux et des repas accord mets-vins.', 209.50, 16),
    (4, 6, 11, 3, 2, 'Séjour en Corse et ses vins', 'sejour30.jpg', 'Sejournez en Corse et decouvrez les vins locaux dans des caves familiales, tout en profitant de la mer et du soleil mediterraneen.', 528.00, null),
    (2, 6, 10, 2, 4, 'Séjour dans le Medoc', 'sejour31.jpg', 'Sejournez dans la region viticole du Medoc, avec des visites de grands crus classes et des degustations exceptionnelles.', 215.00, 17),
    (2, 1, 12, 1, 1, 'Séjour de luxe a Pomerol', 'sejour32.jpg', 'Sejournez dans un cadre de luxe, avec des visites privees de vignobles et des degustations dans la prestigieuse region de Pomerol.', 317.50, 20),
    (4, 2, 8, 1, 3, 'Séjour aventure et vin dans le sud-ouest', 'sejour33.jpg', 'Un séjour pour les aventuriers et les epicuriens, combinant randonnee dans les vignes et degustations de vins typiques du sud-ouest.', 281.00, 13),
    (1, 1, 3, 3, 4, 'Séjour vin et art a Bordeaux', 'sejour66.jpg', 'Un séjour unique a Bordeaux alliant art, culture et decouverte des meilleurs vins locaux, avec des visites de musees et de domaines viticoles.', 241.00, 4),
    (1, 2, 9, 1, 2, 'Séjour vin et patrimoine a Avignon', 'sejour34.jpg', 'Profitez de l''histoire et de l''art a Avignon tout en decouvrant les vins du Vaucluse avec des degustations et des visites guidees de domaines.', 505.50, null),
    (2, 1, 5, 2, 1, 'Séjour en Alsace, au coeur des vignes', 'sejour35.jpg', 'Sejournez en Alsace et partez a la decouverte de ses fameux vins blancs et de ses villages pittoresques, avec des visites de caves et des degustations.', 447.00, null),
    (2, 6, 10, 1, 4, 'Séjour au domaine de la Loire', 'sejour36.jpg', 'Un séjour dans la vallee de la Loire pour explorer les vins locaux tout en decouvrant les châteaux majestueux de la region.', 404.00, 16),
    (4, 6, 10, 1, 3, 'Séjour degustation a Chablis', 'sejour37.jpg', 'Un séjour exclusif dans la region de Chablis, avec des visites de vignobles et des degustations de grands crus blancs.', 162.00, 17),
    (3, 2, 7, 2, 2, 'Séjour decouverte de l''artisanat vinicole', 'sejour38.jpg', 'Visitez des domaines viticoles familiaux, decouvrez l''artisanat de la production de vin et participez a des ateliers pratiques.', 763.00, null),
    (1, 3, 4, 1, 1, 'Séjour oenologique dans les Côtes de Provence', 'sejour39.jpg', 'Explorez les vins roses celebres de la region, avec des visites de domaines viticoles et des moments de detente sur la Côte d''Azur.', 239.00, 9),
    (4, 4, 13, 3, 4, 'Séjour a la decouverte des grands crus de Bordeaux', 'sejour40.jpg', 'Un séjour dans la region bordelaise pour decouvrir les meilleurs grands crus classes et deguster les vins au coeur des prestigieux châteaux.', 345.50, 26),
    (3, 5, 3, 1, 3, 'Séjour viticole et bien-être', 'sejour41.jpg', 'Séjour alliant detente et decouverte, avec des soins au spa et des degustations de vins dans un cadre tranquille et raffine.', 779.00, 1),
    (2, 4, 10, 1, 2, 'Séjour romantique en Savoie', 'sejour42.jpg', 'Un séjour romantique dans les montagnes savoyardes, avec des degustations de vins locaux et des moments privilegies en amoureux.', 506.00, 16),
    (2, 4, 14, 2, 4, 'Séjour au coeur du terroir du Roussillon', 'sejour43.jpg', 'Un séjour pour les amoureux du vin et de la nature, avec des visites de vignobles ensoleilles et des degustations de vins du sud de la France.', 656.00, 32),
    (2, 3, 4, 1, 1, 'Séjour viticole et cuisine provençale', 'sejour44.jpg', 'Un séjour gastronomique où le vin de Provence s''associe a une cuisine locale typique pour une experience inoubliable.', 128.00, 6),
    (2, 5, 8, 1, 3, 'Séjour vin et paysages en Champagne', 'sejour45.jpg', 'Visitez la region de Champagne et decouvrez l''art de la production de champagne, avec des degustations privees et des visites de caves prestigieuses.', 709.00, 14),
    (4, 2, 7, 1, 2, 'Séjour dans les vignes en Languedoc', 'sejour46.jpg', 'Sejournez au coeur des vignobles du Languedoc, avec des degustations de vins locaux et une immersion dans la culture viticole de la region.', 502.50, null),
    (3, 6, 8, 1, 4, 'Séjour en famille a la decouverte du vin', 'sejour47.jpg', 'Un séjour adapte a toute la famille, avec des activites ludiques pour enfants et des degustations pour adultes dans un cadre agreable.', 748.00, 15),
    (1, 6, 6, 1, 1, 'Séjour autour du vin a Bordeaux', 'sejour48.jpg', 'Explorez les vins de Bordeaux a travers des visites de domaines historiques et des degustations de celebres crus classes.', 617.00, 11),
    (2, 5, 14, 2, 2, 'Séjour de degustation en Haute-Savoie', 'sejour49.jpg', 'Decouvrez les vins savoyards, associes a des specialites locales dans un cadre montagnard exceptionnel.', 654.00, 33),
    (3, 6, 3, 2, 3, 'Séjour a la decouverte des vins de Loire', 'sejour50.jpg', 'Un séjour au coeur des vignobles de la Loire, avec des visites guidees de domaines viticoles et des degustations de vins varies.', 289.00, 2),
    (3, 6, 8, 2, 4, 'Séjour vin et art de vivre en Provence', 'sejour51.jpg', 'Venez decouvrir l''art de vivre provençal avec des visites de vignobles, des degustations de vins et des moments de relaxation au coeur de la nature.', 161.00, 12),
    (2, 5, 3, 1, 3, 'Séjour dans un vignoble de Saint-emilion', 'sejour52.jpg', 'Un séjour inoubliable dans un vignoble de Saint-emilion, avec des visites privees et des degustations de vins prestigieux.', 700.50, 5),
    (2, 5, 1, 3, 1, 'Séjour bien-être et vin en Languedoc', 'sejour53.jpg', 'Un séjour alliant detente au spa et degustation de vins locaux dans un cadre exceptionnel en Languedoc.', 744.00, null),
    (3, 4, 2, 3, 4, 'Séjour vin et gastronomie a Lyon', 'sejour54.jpg', 'Venez decouvrir la gastronomie lyonnaise et les vins du Beaujolais a travers un séjour de luxe alliant decouvertes culinaires et oenologiques.', 288.00, null),
    (3, 4, 4, 1, 2, 'Séjour dans un domaine viticole familial', 'sejour55.jpg', 'Sejournez dans un domaine viticole familial et apprenez l''art de la vinification, tout en profitant d''une atmosphere conviviale.', 527.00, 7),
    (3, 2, 14, 2, 3, 'Séjour decouverte des vins du Sud-Est', 'sejour56.jpg', 'Un séjour au coeur des vignobles du Sud-Est, avec des degustations de vins mediterraneens et des visites de villages pittoresques.', 421.50, 34),
    (1, 6, 4, 3, 1, 'Séjour romantique en Bourgogne', 'sejour57.jpg', 'Sejournez dans un cadre romantique en Bourgogne, avec des promenades dans les vignes et des repas en amoureux accompagnes de vins locaux.', 415.00, 8),
    (4, 6, 10, 1, 4, 'Séjour decouverte du vin en Ardeche', 'sejour58.jpg', 'Un séjour dans le sud de la France pour decouvrir les vins d''Ardeche, associes a des activites de plein air et des repas typiques.', 400.00, 17),
    (2, 3, 7, 2, 2, 'Séjour oenotourisme a la decouverte des grands terroirs', 'sejour59.jpg', 'Explorez les plus grands terroirs viticoles français a travers des visites et des degustations exclusives dans des domaines reputes.', 706.00, null),
    (4, 1, 6, 1, 3, 'Séjour luxe et vins en Côtes du Rhône', 'sejour60.jpg', 'Un séjour de luxe dans les Côtes du Rhône avec des degustations de vins rares et des visites privees de grands domaines.', 380.50, 10),
    (3, 5, 1, 3, 1, 'Séjour oenologique en Vallee du Douro', 'sejour61.jpg', 'Partez a la decouverte des vins du Douro au Portugal avec des visites de caves et des degustations de vins du Porto.', 465.00, null),
    (2, 2, 4, 3, 4, 'Séjour dans les vignes de la côte d''Azur', 'sejour62.jpg', 'Sejournez dans la region ensoleillee de la Côte d''Azur et decouvrez ses vins roses, tout en profitant de la mer et des paysages magnifiques.', 383.00, 9),
    (1, 1, 14, 3, 2, 'Séjour au domaine viticole de Loire', 'sejour63.jpg', 'Un séjour au coeur des vignobles de la Loire, avec des visites de châteaux viticoles et des degustations raffinees de vins locaux.', 367.00, 35),
    (1, 6, 5, 2, 3, 'Séjour vin et randonnee dans le vignoble', 'sejour64.jpg', 'Combinez randonnee a travers les vignobles et degustation de vins locaux lors de ce séjour sportif et oenologique.', 372.00, null),
    (3, 6, 13, 2, 4, 'Séjour oenologique a Saint-Emilion', 'sejour65.jpg', 'Un séjour exceptionnel a Saint-Emilion, avec des visites de châteaux et des degustations de vins prestigieux dans un cadre historique.', 683.00, 27),
    (4, 5, 11, 2, 1, 'Séjour decouverte des vins de l''Aude', 'sejour67.jpg', 'Un séjour dans l''Aude, pour decouvrir les vins de la region, avec des visites de caves et des activites en plein air dans un cadre naturel.', 711.50, null),
    (4, 5, 8, 3, 3, 'Séjour en famille dans les vignobles de la Loire', 'sejour68.jpg', 'Un séjour familial avec des activites pour enfants et des degustations pour adultes, tout en explorant les vignobles de la vallee de la Loire.', 462.00, 13),
    (4, 6, 11, 1, 2, 'Séjour oenologique et sportif', 'sejour69.jpg', 'Pour les passionnes de sport et de vin, ce séjour combine des activites en plein air et des degustations de vins locaux dans des lieux pittoresques.', 684.00, null),
    (4, 2, 10, 2, 1, 'Séjour a la decouverte des vins du Medoc', 'sejour70.jpg', 'Partez a la decouverte des grands crus du Medoc, avec des visites de châteaux historiques et des degustations raffinees.', 598.00, 16),
    (2, 5, 9, 3, 4, 'Séjour decouverte de la viticulture biologique', 'sejour71.jpg', 'Un séjour pour les passionnes de vins bio, avec des visites de domaines ecoresponsables et des degustations de vins bio.', 160.00, null),
    (1, 1, 9, 3, 3, 'Séjour bien-être et vins de la Vallee du Rhône', 'sejour72.jpg', 'Un séjour alliant bien-être, detente et decouverte des vins du Rhône, avec des soins au spa et des degustations dans un cadre enchanteur.', 354.50, null),
    (3, 4, 10, 1, 2, 'Séjour au domaine viticole en Champagne', 'sejour73.jpg', 'Venez decouvrir les secrets de la production du champagne et goûter les meilleurs crus de la region lors de ce séjour exclusif.', 302.00, 17),
    (2, 4, 7, 1, 1, 'Séjour decouverte de l''oenotourisme en Languedoc', 'sejour74.jpg', 'Un séjour pour les passionnes d''oenotourisme, avec des visites guidees des meilleurs domaines viticoles du Languedoc et des degustations variees.', 217.00, null),
    (1, 6, 7, 2, 4, 'Séjour decouverte des cepages rares', 'sejour75.jpg', 'Un séjour pour les connaisseurs de vins rares, avec des visites de domaines produisant des cepages peu connus et des degustations inedites.', 512.00, null),
    (1, 6, 2, 3, 3, 'Séjour autour des vins du Roussillon', 'sejour76.jpg', 'Partez a la decouverte des vins du Roussillon, avec des visites de domaines viticoles et des degustations au coeur des montagnes.', 357.00, null),
    (4, 5, 2, 1, 2, 'Séjour oenologique a Sancerre', 'sejour77.jpg', 'Un séjour dans la celebre region viticole de Sancerre, avec des degustations de vins blancs et des visites guidees des plus grands domaines.', 362.00, null),
    (1, 2, 12, 3, 4, 'Séjour viticole en Bourgogne', 'sejour78.jpg', 'Explorez la Bourgogne a travers ses vignobles prestigieux, avec des visites de domaines et des degustations des plus grands crus.', 228.00, 21),
    (4, 5, 2, 3, 1, 'Séjour en toute intimite a Montagne de Reims', 'sejour79.jpg', 'Sejournez dans un cadre intime et prestigieux a Montagne de Reims, avec des degustations de champagne et des visites privees de caves.', 236.00, null),
    (4, 2, 2, 1, 3, 'Séjour decouverte des vins de la Vallee du Tarn', 'sejour80.jpg', 'Venez decouvrir les vins du Tarn, avec des visites de vignobles authentiques et des degustations dans un cadre naturel et preserve.', 619.50, 29),
    (1, 2, 8, 3, 2, 'Séjour oenologique en Côtes de Provence', 'sejour81.jpg', 'Un séjour de rêve en Provence pour decouvrir les vins roses, avec des visites de domaines et des repas gastronomiques dans un cadre idyllique.', 313.00, 14),
    (3, 2, 14, 3, 4, 'Séjour vin et art de vivre en Alsace', 'sejour82.jpg', 'Un séjour unique où se mêlent la degustation de vins d''Alsace et la decouverte de l''art de vivre de cette magnifique region.', 167.00, 31),
    (4, 6, 7, 2, 1, 'Séjour viticole et sportif dans le Languedoc', 'sejour83.jpg', 'Combinez randonnee et degustation de vins dans la region du Languedoc, avec des visites de domaines viticoles au coeur de la nature.', 494.00, null),
    (1, 4, 8, 1, 3, 'Séjour aux portes de la Champagne', 'sejour84.jpg', 'Un séjour au coeur de la Champagne, avec des degustations privees de champagnes et des visites des celebres maisons de la region.', 571.00, 15),
    (3, 2, 8, 3, 2, 'Séjour gourmand et viticole en Provence', 'sejour85.jpg', 'Venez savourer les vins de Provence tout en profitant des delices gastronomiques locaux dans un cadre exceptionnel entre mer et vignes.', 625.50, 15),
    (4, 2, 12, 2, 4, 'Séjour au château de Pommard', 'sejour86.jpg', 'Sejournez dans le prestigieux château de Pommard, avec des visites privees et des degustations de vins fins accompagnees de repas raffines.', 320.00, 22),
    (3, 6, 11, 2, 1, 'Séjour vin et nature en Haute-Loire', 'sejour87.jpg', 'Sejournez en Haute-Loire et decouvrez la beaute des paysages viticoles, avec des randonnees et des degustations de vins locaux.', 749.00, null),
    (4, 1, 14, 1, 3, 'Séjour oenotourisme dans le Medoc', 'sejour88.jpg', 'Partez a la decouverte du Medoc, une region viticole d''exception, avec des visites de grands châteaux et des degustations exclusives.', 721.00, 32),
    (1, 5, 14, 3, 2, 'Séjour decouverte des vins du Sud-Ouest', 'sejour89.jpg', 'Un séjour dans le Sud-Ouest pour explorer ses vins uniques, avec des visites de caves et des degustations en plein coeur de la region.', 650.00, 33),
    (2, 5, 1, 2, 4, 'Séjour autour du vin et des traditions en Provence', 'sejour90.jpg', 'Un séjour en Provence pour decouvrir les traditions viticoles locales a travers des visites de caves et des degustations de vins regionaux.', 455.00, null),
    (1, 4, 14, 2, 1, 'Séjour viticole en Côtes de Nuits', 'sejour91.jpg', 'Sejournez dans la region des Côtes de Nuits, celebre pour ses grands crus de Bourgogne, avec des visites de vignobles et des degustations exclusives.', 319.00, 34),
    (2, 1, 5, 3, 3, 'Séjour vin et nature dans le Languedoc', 'sejour92.jpg', 'Un séjour inoubliable dans les vignobles du Languedoc, alliant la decouverte des vins locaux a des activites en plein air dans un cadre naturel exceptionnel.', 474.00, 28),
    (3, 5, 10, 1, 4, 'Séjour au coeur des vignes de la Loire', 'sejour93.jpg', 'Un séjour dans la vallee de la Loire pour explorer ses vignobles et ses châteaux, avec des degustations de vins authentiques.', 541.00, 16),
    (3, 4, 4, 1, 2, 'Séjour vin et gastronomie a Nantes', 'sejour94.jpg', 'Un séjour a Nantes alliant decouverte des vins de la region et degustation des produits locaux dans un cadre gastronomique raffine.', 643.00, 9),
    (1, 3, 6, 1, 1, 'Séjour viticole et detente en Bourgogne', 'sejour95.jpg', 'Venez vous detendre en Bourgogne tout en decouvrant ses grands vins a travers des visites de domaines et des moments de relaxation au spa.', 702.00, 11),
    (4, 4, 9, 3, 4, 'Séjour vin et patrimoine a Dijon', 'sejour96.jpg', 'Sejournez a Dijon pour decouvrir le patrimoine historique de la ville tout en explorant les vignobles alentours et en degustant des vins locaux.', 372.00, null),
    (3, 3, 6, 1, 3, 'Séjour autour du vin et de l''histoire a Bordeaux', 'sejour97.jpg', 'Plongez dans l''histoire de Bordeaux a travers une visite de ses châteaux viticoles et une degustation de vins du patrimoine de la region.', 696.00, 10),
    (4, 4, 8, 1, 2, 'Séjour vin et paysages en Alsace', 'sejour98.jpg', 'Un séjour dans les vignes d''Alsace pour decouvrir les vins de la region et profiter des paysages a couper le souffle.', 777.00, 13),
    (4, 4, 8, 3, 1, 'Séjour decouverte des grands vins de Bourgogne', 'sejour99.jpg', 'Un séjour a la decouverte des grands vins de Bourgogne, avec des visites de celebres domaines viticoles et des degustations de vins prestigieux.', 312.00, 12),
    (2, 2, 12, 3, 4, 'Séjour de luxe en Côtes du Rhône', 'sejour100.jpg', 'Un séjour de luxe dans la region des Côtes du Rhône, avec des visites privees et des degustations de vins d''exception dans des châteaux historiques.', 687.00, 23);
