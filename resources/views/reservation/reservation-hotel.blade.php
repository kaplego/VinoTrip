                            ...
                            <section id="unereservation">
                                ...
                                <article class ="unclient">
                                    ...
                                    <form method="POST" action="/api/reservationclient">
                                        ...
                                        <p>Envoyer un mail de paiement au client: <button class="button" type="submit" >{{$commande->beneficiaire->emailclient}}</button> </p>
                                        <div>
                                            <p>Validation client :<input type="checkbox" name="validClient" id=validationC ></p>
                                        </div>
                                ...
                                @foreach ( $commande->descriptioncommande->sejour->etape as $unetape)
                                    <article class="unhotel">
                                        <form method="POST" action="/api/reservationhotel">
                                            ...
                                            <p>Envoyer un mail de validation pour la réservation de l'hotel: <button class="button" type="submit">{{$unetape->hebergement->hotel->mailpartenaire}}</button> </p>
                                            <div>
                                                <p>Validation hebergement : <input type="checkbox" name="validHeberg" id=validationH></p>
                                            </div>
